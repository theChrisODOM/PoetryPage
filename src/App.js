  ...
  return (
    <div className="App">
      <div className="PoetrySection">
        ...
        {masterListOfPoetry.filter((currentValue) => {return currentValue.poetry.includes(textFilter)}).map((currentValue) => {return <PoetryCard date={currentValue.date} poetry={currentValue.poetry}/>})}
      </div>
    </div>
  );
}
